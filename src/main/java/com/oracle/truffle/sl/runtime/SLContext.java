...
public final class SLContext {
    ...
    public SLContext(SLLanguage language, Env env, List<NodeFactory<? extends SLBuiltinNode>> externalBuiltins) {
        this.env = env;
     ...
     * native image execution as a consequence of {@link Context#create(String...)}.
     *
