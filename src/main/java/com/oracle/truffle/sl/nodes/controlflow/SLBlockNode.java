...
public final class SLBlockNode extends SLStatementNode implements ElementExecutor<SLStatementNode> {
     ...
     * {@link Node.Children @Children} field. However, this prevents
